query_horario = """Select RESFET FECHAENVIO, RESHOT HORAENVIO,
...
Inner Join BACHIFILES.CUMST As CU On AC.ACMCUN = CU.CUSCUN"""


insert_horario_escenario1 = """ Insert into ach_test.ach_extendido_horario1(FECHAENVIO,HORARIOENVIO,CODIGOOPERADOR,TRANSACCIONEBANCA,NUMCLIENTE,NOMBRECLIENTE,CUENTACARGO,CODIGOBANCODESTINO,CUENTADESTINO,MONTO,FECHALIQUIDACION,HORALIQUIDACION,TIPO,FLAGPENSIONADO,ESTATUS,CODIGORECHAZO)
